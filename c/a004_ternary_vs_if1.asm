...
; /Users/bagjeonghun/git/playground/c/a004_ternary_vs_if.c:9
;     c = a == b ? a : b;
      ...
      40: e8 0f 00 b9  	str	w8, [sp, #12]
      44: 01 00 00 14  	b	0x48 <ltmp0+0x48>
      48: e8 0f 40 b9  	ldr	w8, [sp, #12]
; /Users/bagjeonghun/git/playground/c/a004_ternary_vs_if.c:9
;     c = a == b ? a : b;
      4c: e8 13 00 b9  	str	w8, [sp, #16]
; /Users/bagjeonghun/git/playground/c/a004_ternary_vs_if.c:19
;     printf("c = %d\n", c);
      50: e9 13 40 b9  	ldr	w9, [sp, #16]
      54: e8 03 09 aa  	mov	x8, x9
      58: e9 03 00 91  	mov	x9, sp
      5c: 28 01 00 f9  	str	x8, [x9]
      60: 00 00 00 90  	adrp	x0, 0x0 <ltmp0+0x60>
      64: 00 00 00 91  	add	x0, x0, #0
; /Users/bagjeonghun/git/playground/c/a004_ternary_vs_if.c:19
;     printf("c = %d\n", c);
      68: 00 00 00 94  	bl	0x68 <ltmp0+0x68>
